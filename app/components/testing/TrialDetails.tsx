        ...
        >
          ...
          <div className="mt-8 flex flex-col items-center gap-4">
            <a
              ...
              className="hover-white inline-flex w-full items-center justify-center rounded-lg bg-[#16335b] px-8 py-3.5 font-medium tracking-[0.14em] text-[#f2f2f3] transition hover:bg-[#ba9e78] sm:w-auto"
              style={{ fontFamily: "var(--font-montserrat, sans-serif)" }}
            >
              Start My Trial
            </a>
